...
* Make sure you are using the latest GroupDocs.Annotation version before reporting an issue. See [GroupDocs.Annotation for .NET NuGet Package](https://www.nuget.org/packages/GroupDocs.Annotation/) to find out about the latest version.
